...
- Outlines the roadmap for the full project
...
## **03 — Positional Information in Transformers**
Transformers need a way to represent sequence order.  
Section 03 covers both major approaches used in modern models.

### **03a — Sinusoidal Positional Encodings**
- Explain why transformers need positional information
- Implement the sinusoidal encoding formula from the original paper  
- Build intuition using waves (frequency, amplitude, phase)
- Visualize multi-frequency positional patterns

### **03b — Learned Positional Embeddings**
- Introduce learned position vectors as trainable parameters  
- Show how positional embeddings are stored and indexed  
- Visualize positional embedding matrices  
- Combine token + position embeddings (the true input to a Transformer layer)
